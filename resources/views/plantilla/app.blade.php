        ...
        <div class="container body">
            <div class="main_container">
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="{{url('/admin')}}" class="site_title"><i class="fa fa-paw"></i> <span>Administrador</span></a>
                        </div>
                        ...
                        <div class="profile clearfix">
                            <div class="profile_pic">
                                <!--<img src="images/img.jpg" alt="..." class="img-circle profile_img"> imagen de perfil-->
                            </div>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        <img src="images/img.jpg" alt="">{{Session::has("admin")?Session::get("admin")->nombre:""}}
                ...
                <footer>
                    ...
                    <div class="pull-left">
                        <a href="https://luisplata.github.io" target="_blank">Creado por Luis Plata</a>
                    </div>
                    <div class="clearfix"></div>
                </footer>
                <!-- /footer content -->
