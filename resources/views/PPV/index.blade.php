        ...
        <div id="main">
            <div class="inner">
                ...
                <header id="header">
                    ...
                    <ul class="icons">
                        <li><a href="{{ env('OnlyFree', '#') }}" target="_blank" class="icon brands fa-telegram"><span
                                    class="label">OnlyFree.com</span></a></li>
                ...
                <section class="row">
                    <div class="row row-cols-1 row-cols-sm-2" id="contentPacks">
                        @foreach ($packs as $pack)
                            <div class="col-3">
                                <a href="{{ env('HOME') }}content/{{ $pack->url }}">
                                    <div class="card bg-dark center">
                                        ...
                                        <div class="card-img-overlay text-center">
                                            <h2 class="card-title">{{ $pack->nombre }} Stream</h2>
                                        </div>
                                    </div>
                                </a>
                            </div>
