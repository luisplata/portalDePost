        ...
        <div class="inner">
            ...
            <section class="row">
                <div class="row row-cols-2 row-cols-sm-3" id="contentPacks">
                    @foreach ($posts as $stream)
                        <div class="col">
                            <a href="{{ env('HOME') }}content/{{ $stream->ConvertNameNormalToUrl() }}">
                                <div class="card bg-dark text-center">
                                    <img src="{{ $stream->imagen }}" class="card-img">
                                    <div class="card-body">
                                        <p class="card-text"></p>
                                        <h2 class="card-title">{{ $stream->nombre }}</h2>
                                        <p></p>
                                    </div>
                                </div>
                            </a>
